...
He follows this by introducing the various open source hardware and software available
...
for craftsman. This includes the various types 3D printers, Fused Filament Extrusion,
...
Franco goes onto share the different _“physical libraries”_, _“virtual libraries”_ and
the different editors.

![wwx 2014 haxe openbuilds grid-1-5](/img/wwx/2014/openbuilds1.png "Open Builds Part Store")
![wwx 2014 haxe openbuilds grid-1-5](/img/wwx/2014/openbuilds.png "Open Builds")
![wwx 2014 haxe adafruit grid-1-5](/img/wwx/2014/adafruit2.png "Adafruit")
![wwx 2014 haxe sparkfun grid-1-5](/img/wwx/2014/sparkfun.png "Sparkfun")
![wwx 2014 haxe seeed grid-1-5](/img/wwx/2014/seeed.png "Seeed")

![wwx 2014 haxe thingiverse grid-1-4](/img/wwx/2014/thingiverse.png "Thingiverse")
![wwx 2014 haxe bld3r grid-1-4](/img/wwx/2014/bld3r.png "Bld3r")
![wwx 2014 haxe ponoko grid-1-4](/img/wwx/2014/ponoko.png "Ponoko")
![wwx 2014 haxe 3d hacker grid-1-4](/img/wwx/2014/3dhacker.png "3D Hacker!")

![wwx 2014 haxe inkscape grid-1-4](/img/wwx/2014/inkscape.png "Inkscape")
![wwx 2014 haxe openscad grid-1-4](/img/wwx/2014/openscad.png "OpenSCAD")
![wwx 2014 haxe openjscad grid-1-4](/img/wwx/2014/openjscad.png "OpenJSCAD")
![wwx 2014 haxe tinkercad grid-1-4](/img/wwx/2014/tinkercad.jpg "Tinkercad")

Franco reckons there is an opportunity for Haxe developers to build upon in the
maker space, check out his [demo][36] for his take on an in browser 3D editor. The 
Haxe compiler can be run on any Linux compatible pocket computer board, the 
BeagleBone Black and Raspberry PI as just a couple which are compatible.

There are many boards which support a compile target, C++, JavaScript, CSharp, Python
...
but now all you have to add to your `hxml` file is `-net-lib path/to/lib.dll`. So in
the case for Unity3D add `-net-lib libs/UnityEngine.dll -net-lib libs/UnityEditor.dll`.
This is the C# targets version of `-java-lib` and `-swf-lib` already part of the
compiler which means you no longer need to create externs.
...
[l36]: https://rawgit.com/fponticelli/chad/master/bin/index.html "Opportunity for Haxe developers?"
