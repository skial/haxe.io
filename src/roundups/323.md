...
private rooms, dynamic favicons and a homemade captcha system all built with Haxe
and [Abe][l21].

The [Shark Punch][tw8] team have officially released The Masterplan, now
available from [Steam][l22] made with Haxe and OpenFL for Windows, OSX and SteamOS/Linux.
