...
[Niall Weedon][tw7] has updated his library [hxdecorate][l14] to now support 
the JavaScript, Python and C++ compiler targets.

[Matthijs Kamstra][tw8] has released another weekly update to HaxeNode, a
...
[Midori Kocak][tw9] has used Haxe and JavaScript to create a TodoMVC example app, 
[available from GitHub][l16], which you can also [try out online][l17]. 

[Pete Shand][tw9] has updated his [Haxe Delay][l18] library by removing OpenFL
