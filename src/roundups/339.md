...
an improved article on [Automotion using Haxe and NodeJS][l52]. If you have any
...
[Siratama][tw20] released a runtime metadata utility as a [gist onto GitHub][l53]
showcasing the different usecases for using runtime metadata. 
...
To finish this weeks roundup off is the new the Haxe Foundation have released
