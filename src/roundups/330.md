...
working going on to published on all platforms/consoles at once. Motion Twins
are already on the roll, with their lastest game [RockFaller Journey][l17], deployed
on Android, iOS and Flash and available from the [App Store][l18], the [Play Store][l19]
and Amazon.
