...
You can get started using the latest features by downloading a [nightly build] of Haxe and see the latest changes impact on each by browsing the [benchmarks] site.
