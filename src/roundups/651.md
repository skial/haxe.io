...
- [Autoball](https://ldj.am/51/autoball) by torcado using OpenFL. `7th`
- [Near Death Sentence](https://ldj.am/$296600) by [jefvel](https://ldj.am/@jefvel). `23rd`
- [Relay PeaJay](https://ldj.am/51/relay-peajay) and quick intro [article](https://aeveis.tumblr.com/post/697149538597830656/relay-peajay-by-aeveis) by Aeveis made with HaxeFlixel. `24th`
- [Drill Bill](https://ldj.am/51/drill-bill) by [Aurel](https://twitter.com/Aurel300/status/1577431983973486592) and [Eido Volta](https://ldj.am/@eidovolta). `25th`
- [Heartbeat](https://ldj.am/51/heartbeat-1) by [Yanrishatum `code`](https://twitter.com/yanrishatum), [Shess `art/story`](https://twitter.com/yenneash), [bublick `art`](https://www.artstation.com/dari_mak) and [Elvendan `music`](https://soundcloud.com/elvenaudio). `60th`
- [Assault on Hartblood Hotel](https://ldj.am/51/assault-on-hartblood-hotel) by [fireslash `code`](https://ldj.am/@fireslash), [kiririn51 `art/writing`](https://ldj.am/@kiririn51) and [juneji `music`](https://ldj.am/@juneji).
- [I'm Just Hungry](https://ldj.am/51/im-just-hungry) by [zwodahs](https://ldj.am/@zwodahs).
...
- [Be Fast!](https://ldj.am/51/be-fast) by [codescapade](https://ldj.am/@codescapade) using [aeons `git`](https://github.com/codescapade/aeons).
