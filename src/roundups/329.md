...
If you're using a Lime, a lightweight unified API, or OpenFL, [Jérémy Faivre][tw8] 
...
solver for layout, the same algorithm that's forms the core of OSX and iOS layouts.
...
improve your skills, [Jeremy McCurdy][tw16] is writing a **new** Haxe book,
called [Haxe Game Development Essentials][l18], which you can pre-order now!

For those of us who **don't** use Haxe for gamedev, here are a few items that
might interest you.
