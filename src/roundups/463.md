...
- [Total Party Kill](https://ldj.am/43/total-party-kill) by [Jussi Simpanen](https://twitter.com/AdventIslands) has reached `1st` place in **Overall** and **Theme** among all other games made for LudumDare 43. :tada:
