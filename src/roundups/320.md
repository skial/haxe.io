...
the most starred Haxe repo and has been featured in an Engadget [article][l8]. 
George has ported the GPU Fluid simulator from using Lime to snõw.

[Anders Nissen][tw3] has created a [curated list][l9] of resources from the snõwkit
collective covering the more popular libraries, [flõw][l10], 
[snõw][l11] and [luxe][l12] with _plenty_ of game examples, LD31 and LD32 games made using
snõw and luxe, as well as [mínt][l13], [hxsw][l14] and others.

[Sven Bergström][tw4] has posted over on the snõwkit community site a quick [article][l17]
which tells you the state of the snõwkit libraries against Haxe `3.2.0`. _Basically_
...
Evoland 2 is due for release this summer and is now taking [preorders][l37]. It is created by [Shiro Games][tw10] co-founded by [Nicolas Cannasse][tw11]. To finish this weeks roundup off is here the newly released official trailer for the game.
